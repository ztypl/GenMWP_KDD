...
def train_topic_attn(input_batch, topic_batch, target_batch,
               encoder, decoder,
    ...
    encoder_output, encoder_hidden = encoder(input_seqs.T, input_lens, topic_batch, None)
